...
class ShareApplication(Document):  # Corrected class declaration
       pass
...
# #         Assign the uppercase name to the relevant fields
...
# #             else:
# #                 created = self._create_share_ac_no()  # Create if not found
# #                 if created:
# #                     share_account_number = frappe.db.get_value(
# #                         "Share Account", {"share_application_number": self.name}, "name"
# #                     )
...
# #                     else:
# #                         frappe.throw(
# #                             "Unable to retrieve Share Account Number after creation. Please try again."
# #                         )
# #                 else:
# #                     frappe.throw(
# #                         "Failed to create Share Account Number. Please try again."
# #                     )
# #         except Exception as e:
# #             frappe.throw(f"Error setting Share Account Number: {e}")
...
# #             else:
# #                 frappe.log_error(
# #                     f"Share Account document creation failed for Share Application {self.name}."
# #                 )
# #                 frappe.throw("Failed to create Share Account. Please try again.")
# #                 return False
# #         except Exception as e:
