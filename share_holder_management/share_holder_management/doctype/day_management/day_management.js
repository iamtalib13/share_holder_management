    ...
    frm.call({
      ...
      callback: function (r) {
        if (!r.exc) {
          ...
          let empuser = frappe.session.user;
          let eid = empuser.match(/\d+/)[0];
          console.log("empuser:", eid);
                ...
                frappe.call({
                  ...
                  callback: function (employeeResponse) {
                    if (!employeeResponse.exc) {
                      ...
                      const employeeName =
                        employeeResponse.message.employee_name;
                      ...
                      frm.call({
                        ...
                        callback: function (r) {
                          if (!r.exc) {
                            ...
                            const allBranchesStarted =
                              totalStart === totalBranch;

                            const startButtonHtml = !startDetails.log_type
                              ? `<button class="ho_button" onclick="startHO('${branch}', '${formattedDate}', '${eid}', '${employeeName}')">Start HO Day</button>`
                              : "";
                            ...
                            const endButtonHtml = showEndButton
                              ? `<button id="endBranchButton" class="ho_button" onclick="endHO('${branch}', '${formattedDate}', '${eid}', '${employeeName}')">End HO Day</button>`
                              : "";
                            ...
                            const dayEndedFlag = checkhoDayEnded
                              ? "true"
                              : "false";
                            console.log("Branch ended", dayEndedFlag);

                            const branchstartButtonHtml =
                              startDetails.log_type === "Start" &&
                              totalStart < totalBranch
                                ? `<div class="ho_btn">
                                      <button class="ho_button" onclick="startBranch('${eid}', '${employeeName}')">Start Branches Day</button>
                                   </div>`
                                : "";

                            const branchEndButtonHtml =
                              allBranchesStarted && !checkhoDayEnded
                                ? `<div class="ho_btn">
                                      <button class="ho_button" onclick="endBranch('${eid}', '${employeeName}')">End Branches Day</button>
                                   </div>`
                                : "";

                            // Determine if all branches have ended
                            if (checkhoDayEnded) {
                              // Hide the end button for branches
                              const endBranchButton =
                                document.getElementById("endBranchButton");
                              if (endBranchButton) {
                                endBranchButton.style.display = "none";
                              }
                            }
                            ...
                            let html = `<!DOCTYPE html>
                                                        <html lang="en">
                                                            <head>
                                                                ...
                                                                <script>
                                                                // To start HO on btn click
                                                                  function startHO(branch, formattedDate, eid, employeeName) {
                                                                    const empid = eid;
                                                                    ...
                                                                    //calling server method to check status for working date
                                                                    frappe.call({
                                                                      ...
                                                                      callback: function (response) {
                                                                        if (!response.exc) {
                                                                          ...
                                                                          console.log("Formatted Date and Time:", modifiedDate);

                                                                          frappe.call({
                                                                            method: "share_holder_management.share_holder_management.doctype.day_management.day_management.start_HO_day",
                                                                            args: {
                                                                              branch: branch,
                                                                            ...
                                                                            callback: function(response) {
                                                                              if (!response.exc) {
                                                                                console.log("HO Day started successfully.");
                                                                  ...
                                                                  // To start all branches on btn click
                                                                  function startBranch(eid, employeeName){
                                                                    console.log("Employee ID:", eid);                                  
                                                                    console.log("Employee Name:", employeeName);
                                                                    ...
                                                                    frappe.call({
                                                                      ...
                                                                      callback: function (response) {
                                                                        if (!response.exc) {
                                                                          ...
                                                                          // calling start branch day server function at time of HO day start
                                                                          frappe.call({
                                                                            method: "share_holder_management.share_holder_management.task.day_start",
                                                                            args: {
                                                                              datetime_str: modifiedDate,
                                                                              userId: eid,
                                                                              employeeName: employeeName
                                                                            ...
                                                                            callback: function (response) {
                                                                              ...
                                                                              if (!response.exc) {
                                                                                // Handle success
                                                                                console.log("All Branches Day started successfully.");
                                                                              
                                                                                frappe.show_alert({
                                                                                  message: __('All Branches started Successfully'),
                                                                                  indicator: 'green'
                                                                                }, 5);
                                                                  ...
                                                                  // To End all branches on btn click
                                                                  function endBranch(eid, employeeName){
                                                                    console.log("Employee ID:", eid);                                  
                                                                    console.log("Employee Name:", employeeName);
                                                                    ...
                                                                    frappe.call({
                                                                      ...
                                                                      callback: function (response) {
                                                                        if (!response.exc) {
                                                                          ...
                                                                          // calling start branch day server function at time of HO day start
                                                                          frappe.call({
                                                                            method: "share_holder_management.share_holder_management.task.day_end",
                                                                            args: {
                                                                              datetime_str: modifiedDate,
                                                                              userId: eid,
                                                                              employeeName: employeeName
                                                                            ...
                                                                            callback: function (response) {
                                                                              ...
                                                                              if (!response.exc) {
                                                                                // Handle success
                                                                                console.log("All Branches Day Ended successfully.");
                                                                              
                                                                                frappe.show_alert({
                                                                                  message: __('All Branches Ended Successfully'),
                                                                                  indicator: 'green'
                                                                                }, 5);
                                                                  ...
                                                                  function endHO(branch, formattedDate, eid, employeeName){
                                                                    const empid = eid;
                                                                    console.log("Employee ID:", eid);
                                                                    console.log("Branch:", branch);
                                                                    console.log("Formatted Date:", formattedDate);
                                                                    ...
                                                                    frappe.call({
                                                                      ...
                                                                      callback: function (response) {
                                                                        if (!response.exc) {
                                                                          ...
                                                                          frappe.call({
                                                                            method: "share_holder_management.share_holder_management.doctype.day_management.day_management.end_HO_day",
                                                                            args: {
                                                                              branch: branch,
                                                                              datetime_str: modifiedDate,
                                                                              userId: eid,
                                                                            ...
                                                                            callback: function(response) {
                                                                              if (!response.exc) {
                                                                                console.log("HO Day Ended successfully.");
                                                                    ...
                                                                    <div class="ho_metrics">
                                                                        ...
                                                                        <div class="ho_metric">
                                                                            <div class="ho_metric-grid">
                                                                                ...
                                                                                <div class="ho_value">
                                                                                    <span style="color: #948C8C; font-size: 14px; font-weight: 600;" class="ho_label-secondary">BRANCHES</span>
